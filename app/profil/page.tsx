    ...
    <div className="flex flex-col min-h-full bg-gray-50">
      ...
      <div className="px-4 pt-8 pb-8 relative overflow-hidden bg-white border-b border-gray-100">
        ...
        <div className="flex flex-col items-center relative mt-4">
          <div
            className={`w-24 h-24 rounded-full flex items-center justify-center text-white font-bold text-3xl shadow-md mb-4 overflow-hidden border-4 border-white ${groupColors[roleName] ?? 'bg-blue-400'}`}
          >
          ...
          <span className="mt-2 inline-block text-xs font-semibold bg-blue-50 text-blue-600 px-3 py-1 rounded-full">
            {roleName}
          </span>
        </div>
      </div>
