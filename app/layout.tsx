  ...
  return (
    <html lang="id" className="h-full">
        ...
        <div className="fixed inset-0 pointer-events-none z-[-1] overflow-hidden">
          ...
          <div className="absolute top-[20%] right-[-10%] w-[30%] h-[30%] bg-primary-accent/5 rounded-full blur-[100px]" />
          <div className="absolute bottom-[-10%] left-[20%] w-[50%] h-[50%] bg-primary-accent/10 rounded-full blur-[120px]" />
        </div>
