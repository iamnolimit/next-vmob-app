      ...
      <div className="px-4 py-5 space-y-3 flex-1">
        {submitted ? (
          ...
          <div className="bg-white rounded-2xl ios-shadow px-6 py-8 flex flex-col items-center text-center gap-3">
            ...
            <button
              onClick={() => router.back()}
              className="mt-2 w-full bg-primary-accent text-white text-sm font-semibold py-3 rounded-xl active:bg-primary-accent/90"
            >
              Kembali ke Profil
            </button>
          </div>
          ...
          <>
            ...
            <button
              ...
              className="w-full bg-primary-accent text-white text-sm font-semibold py-3.5 rounded-2xl active:bg-primary-accent/90 transition-colors shadow-sm"
            >
